...
const { get_flight_details, get_airport, get_flightsAiport, get_flightsAirlines, get_liveFlight,get_info_airports } = require("../controller/controllers.js")
...
router.get("/byAirport/:dept_iataCode/:arr_iataCode/:flight_date", airportValidate, get_airport)
...
router.get("/allairports", get_info_airports)
